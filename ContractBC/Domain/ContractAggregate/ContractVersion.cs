...
namespace ContractBC.ContractAggregate
{
    public class ContractVersion:BaseEntity<Guid>
    {
        ...
        public static ContractVersion CreateNewWithCustomDeadline(BaseAttributes attribs, DateTime deadline)
        {
            return new ContractVersion(SpecificationSet.Default(), attribs, deadline,false);
        }
        public static ContractVersion CreateRevision(BaseAttributes attribs,SpecificationSet specs,bool hasRevisedSpecs)
        {
            return new ContractVersion(specs, attribs, null,hasRevisedSpecs); ;
        }
        public static ContractVersion CreateRevisionWithCustomDeadline(BaseAttributes attribs, SpecificationSet specs, bool hasRevisedSpecs,DateTime deadline)
        {
            return new ContractVersion(specs, attribs, deadline,hasRevisedSpecs); 
        }
        private ContractVersion(SpecificationSet specs,BaseAttributes attribs, DateTime? deadline,bool revisedSpecs)
        {
            Id = Guid.NewGuid();
